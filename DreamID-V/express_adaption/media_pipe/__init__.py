...
from .pose_util import euler_and_translation_to_matrix, matrix_to_euler_and_translation, project_points_with_trans
...
class FaceMeshAlign:
    ...
    def __call__(self, ref_result, temp_results):
        ...
        projected_vertices = project_points_with_trans(
            verts_arr, pose_mat_smooth, [height, width]
        )  # projected_vertices.shape (97, 468, 2)
