...
> **Location in repo:** `LTX-2/app/docs/architecture.md`
...
This document captures the original VTX app specification and milestone plan. It is a
source-of-truth reference for architecture, scope, and quality gates.
