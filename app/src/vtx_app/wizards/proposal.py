...
class ProposalGenerator:
    ...
    def analyze_concept(self, text: str) -> dict[str, Any]:
        ...
        schema = {
            ...
            "required": ["title", "slug", "logline", "visual_style_keywords", "synopsis"],
        ...
        try:
            resp = client.chat.completions.create(
                ...
                messages=[
                    {"role": "system", "content": "You are a movie producer. Analyze the user's movie idea."},
                    {"role": "user", "content": f"Idea: {text}\n\nExtract title, slug, visual style keywords, and synopsis."},
                ],
                functions=[{"name": "set_metadata", "parameters": schema}], # Using functions for older models compatibility or structured output
    ...
    def create_proposal(self, concept_text: str) -> dict[str, Any]:
        ...
        print(f"[blue]Searching CivitAI for styles: {analysis['visual_style_keywords']}...[/blue]")
        ...
        proposal = {
            ...
            "story": {
                "brief": analysis["synopsis"]
            },
            "resources": {
                "suggested_loras": suggested_loras
            },
